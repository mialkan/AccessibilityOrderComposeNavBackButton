 ...
 */
/* Needed because of
https://github.com/material-components/material-components-android/issues/2348
https://github.com/material-components/material-components-android/issues/2176
See Corrado notes for what I changed(Inside BaseSliderAccessible)
 */
@SuppressLint("RestrictedApi")
public class SliderAccessible extends BaseSliderAccessible<SliderAccessible, SliderAccessible.OnChangeListener, SliderAccessible.OnSliderTouchListener> {

    public SliderAccessible(@NonNull Context context) {
        this(context, null);
    }

    public SliderAccessible(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, R.attr.sliderStyle);
    }

    public SliderAccessible(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
     ...
     */
    public interface OnChangeListener extends BaseOnChangeListener<SliderAccessible> {
    }
     ...
     * started/stopped.
     */
    public interface OnSliderTouchListener extends BaseOnSliderTouchListener<SliderAccessible> {
    }
}
